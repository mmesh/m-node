...
func (VSCNAMEStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_mmesh_protobuf_resources_v1_topology_vs_proto_enumTypes[1].Descriptor()
}

func (VSCNAMEStatus) Type() protoreflect.EnumType {
	return &file_mmesh_protobuf_resources_v1_topology_vs_proto_enumTypes[1]
}
...
func (x *CheckVSCNAMERequest) Reset() {
	*x = CheckVSCNAMERequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mmesh_protobuf_resources_v1_topology_vs_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CheckVSCNAMERequest) Descriptor() ([]byte, []int) {
	return file_mmesh_protobuf_resources_v1_topology_vs_proto_rawDescGZIP(), []int{10}
}
...
func (x *CheckVSCNAMEResponse) Reset() {
	*x = CheckVSCNAMEResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mmesh_protobuf_resources_v1_topology_vs_proto_msgTypes[11]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CheckVSCNAMEResponse) Descriptor() ([]byte, []int) {
	return file_mmesh_protobuf_resources_v1_topology_vs_proto_rawDescGZIP(), []int{11}
}
...
var file_mmesh_protobuf_resources_v1_topology_vs_proto_rawDesc = []byte{
	...
	0x53, 0x54, 0x41, 0x54, 0x55, 0x53, 0x5f, 0x45, 0x52, 0x52, 0x4f, 0x52, 0x10, 0x15, 0x42, 0x2c,
...
var file_mmesh_protobuf_resources_v1_topology_vs_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_mmesh_protobuf_resources_v1_topology_vs_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
...
func file_mmesh_protobuf_resources_v1_topology_vs_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_mmesh_protobuf_resources_v1_topology_vs_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
		...
		file_mmesh_protobuf_resources_v1_topology_vs_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
