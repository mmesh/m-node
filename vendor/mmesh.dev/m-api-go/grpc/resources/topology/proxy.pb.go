...
// 	protoc        v5.26.0--rc3
// source: mmesh/protobuf/resources/v1/topology/proxy.proto
...
func (x *Proxy) Reset() {
	*x = Proxy{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mmesh_protobuf_resources_v1_topology_proxy_proto_msgTypes[0]
...
func (*Proxy) Descriptor() ([]byte, []int) {
	return file_mmesh_protobuf_resources_v1_topology_proxy_proto_rawDescGZIP(), []int{0}
}
...
func (x *ProxyCfg) Reset() {
	*x = ProxyCfg{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mmesh_protobuf_resources_v1_topology_proxy_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ProxyCfg) Descriptor() ([]byte, []int) {
	return file_mmesh_protobuf_resources_v1_topology_proxy_proto_rawDescGZIP(), []int{1}
}
...
func (x *ProxyAgent) Reset() {
	*x = ProxyAgent{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mmesh_protobuf_resources_v1_topology_proxy_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ProxyAgent) Descriptor() ([]byte, []int) {
	return file_mmesh_protobuf_resources_v1_topology_proxy_proto_rawDescGZIP(), []int{2}
}
...
var File_mmesh_protobuf_resources_v1_topology_proxy_proto protoreflect.FileDescriptor

var file_mmesh_protobuf_resources_v1_topology_proxy_proto_rawDesc = []byte{
	...
	0x08, 0x52, 0x07, 0x64, 0x65, 0x76, 0x4d, 0x6f, 0x64, 0x65, 0x42, 0x2c, 0x5a, 0x2a, 0x6d, 0x6d,
...
var (
	file_mmesh_protobuf_resources_v1_topology_proxy_proto_rawDescOnce sync.Once
	file_mmesh_protobuf_resources_v1_topology_proxy_proto_rawDescData = file_mmesh_protobuf_resources_v1_topology_proxy_proto_rawDesc
)

func file_mmesh_protobuf_resources_v1_topology_proxy_proto_rawDescGZIP() []byte {
	file_mmesh_protobuf_resources_v1_topology_proxy_proto_rawDescOnce.Do(func() {
		file_mmesh_protobuf_resources_v1_topology_proxy_proto_rawDescData = protoimpl.X.CompressGZIP(file_mmesh_protobuf_resources_v1_topology_proxy_proto_rawDescData)
	})
	return file_mmesh_protobuf_resources_v1_topology_proxy_proto_rawDescData
}

var file_mmesh_protobuf_resources_v1_topology_proxy_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_mmesh_protobuf_resources_v1_topology_proxy_proto_goTypes = []interface{}{
	(*Proxy)(nil),      // 0: topology.Proxy
	(*ProxyCfg)(nil),   // 1: topology.ProxyCfg
	(*ProxyAgent)(nil), // 2: topology.ProxyAgent
}
var file_mmesh_protobuf_resources_v1_topology_proxy_proto_depIdxs = []int32{
...
func init() { file_mmesh_protobuf_resources_v1_topology_proxy_proto_init() }
func file_mmesh_protobuf_resources_v1_topology_proxy_proto_init() {
	if File_mmesh_protobuf_resources_v1_topology_proxy_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_mmesh_protobuf_resources_v1_topology_proxy_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Proxy); i {
			case 0:
				return &v.state
			case 1:
		...
		file_mmesh_protobuf_resources_v1_topology_proxy_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_mmesh_protobuf_resources_v1_topology_proxy_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_mmesh_protobuf_resources_v1_topology_proxy_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_mmesh_protobuf_resources_v1_topology_proxy_proto_goTypes,
		DependencyIndexes: file_mmesh_protobuf_resources_v1_topology_proxy_proto_depIdxs,
		MessageInfos:      file_mmesh_protobuf_resources_v1_topology_proxy_proto_msgTypes,
	}.Build()
	File_mmesh_protobuf_resources_v1_topology_proxy_proto = out.File
	file_mmesh_protobuf_resources_v1_topology_proxy_proto_rawDesc = nil
	file_mmesh_protobuf_resources_v1_topology_proxy_proto_goTypes = nil
	file_mmesh_protobuf_resources_v1_topology_proxy_proto_depIdxs = nil
}
