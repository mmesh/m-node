...
// 	protoc        v5.26.0--rc3
// source: mmesh/protobuf/resources/v1/hsec/license.proto
...
func (x *DetectedLicense) Reset() {
	*x = DetectedLicense{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mmesh_protobuf_resources_v1_hsec_license_proto_msgTypes[0]
...
func (*DetectedLicense) Descriptor() ([]byte, []int) {
	return file_mmesh_protobuf_resources_v1_hsec_license_proto_rawDescGZIP(), []int{0}
}
...
var File_mmesh_protobuf_resources_v1_hsec_license_proto protoreflect.FileDescriptor

var file_mmesh_protobuf_resources_v1_hsec_license_proto_rawDesc = []byte{
	...
	0x42, 0x28, 0x5a, 0x26, 0x6d, 0x6d, 0x65, 0x73, 0x68, 0x2e, 0x64, 0x65, 0x76, 0x2f, 0x6d, 0x2d,
...
var (
	file_mmesh_protobuf_resources_v1_hsec_license_proto_rawDescOnce sync.Once
	file_mmesh_protobuf_resources_v1_hsec_license_proto_rawDescData = file_mmesh_protobuf_resources_v1_hsec_license_proto_rawDesc
)

func file_mmesh_protobuf_resources_v1_hsec_license_proto_rawDescGZIP() []byte {
	file_mmesh_protobuf_resources_v1_hsec_license_proto_rawDescOnce.Do(func() {
		file_mmesh_protobuf_resources_v1_hsec_license_proto_rawDescData = protoimpl.X.CompressGZIP(file_mmesh_protobuf_resources_v1_hsec_license_proto_rawDescData)
	})
	return file_mmesh_protobuf_resources_v1_hsec_license_proto_rawDescData
}

var file_mmesh_protobuf_resources_v1_hsec_license_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_mmesh_protobuf_resources_v1_hsec_license_proto_goTypes = []interface{}{
	(*DetectedLicense)(nil), // 0: hsec.DetectedLicense
}
var file_mmesh_protobuf_resources_v1_hsec_license_proto_depIdxs = []int32{
...
func init() { file_mmesh_protobuf_resources_v1_hsec_license_proto_init() }
func file_mmesh_protobuf_resources_v1_hsec_license_proto_init() {
	if File_mmesh_protobuf_resources_v1_hsec_license_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_mmesh_protobuf_resources_v1_hsec_license_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_mmesh_protobuf_resources_v1_hsec_license_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_mmesh_protobuf_resources_v1_hsec_license_proto_goTypes,
		DependencyIndexes: file_mmesh_protobuf_resources_v1_hsec_license_proto_depIdxs,
		MessageInfos:      file_mmesh_protobuf_resources_v1_hsec_license_proto_msgTypes,
	}.Build()
	File_mmesh_protobuf_resources_v1_hsec_license_proto = out.File
	file_mmesh_protobuf_resources_v1_hsec_license_proto_rawDesc = nil
	file_mmesh_protobuf_resources_v1_hsec_license_proto_goTypes = nil
	file_mmesh_protobuf_resources_v1_hsec_license_proto_depIdxs = nil
}
