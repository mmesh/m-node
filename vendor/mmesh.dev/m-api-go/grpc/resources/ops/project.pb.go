...
// 	protoc        v4.25.2
// source: mmesh/protobuf/resources/v1/ops/project.proto
...
func (x *NewProjectRequest) Reset() {
	*x = NewProjectRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mmesh_protobuf_resources_v1_ops_project_proto_msgTypes[0]
...
func (*NewProjectRequest) Descriptor() ([]byte, []int) {
	return file_mmesh_protobuf_resources_v1_ops_project_proto_rawDescGZIP(), []int{0}
}
...
func (x *Project) Reset() {
	*x = Project{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mmesh_protobuf_resources_v1_ops_project_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Project) Descriptor() ([]byte, []int) {
	return file_mmesh_protobuf_resources_v1_ops_project_proto_rawDescGZIP(), []int{1}
}
...
func (x *Projects) Reset() {
	*x = Projects{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mmesh_protobuf_resources_v1_ops_project_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Projects) Descriptor() ([]byte, []int) {
	return file_mmesh_protobuf_resources_v1_ops_project_proto_rawDescGZIP(), []int{2}
}
...
func (x *ListProjectsRequest) Reset() {
	*x = ListProjectsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mmesh_protobuf_resources_v1_ops_project_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ListProjectsRequest) Descriptor() ([]byte, []int) {
	return file_mmesh_protobuf_resources_v1_ops_project_proto_rawDescGZIP(), []int{3}
}
...
func (x *ProjectReq) Reset() {
	*x = ProjectReq{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mmesh_protobuf_resources_v1_ops_project_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ProjectReq) Descriptor() ([]byte, []int) {
	return file_mmesh_protobuf_resources_v1_ops_project_proto_rawDescGZIP(), []int{4}
}
...
var File_mmesh_protobuf_resources_v1_ops_project_proto protoreflect.FileDescriptor

var file_mmesh_protobuf_resources_v1_ops_project_proto_rawDesc = []byte{
	...
	0x03, 0x6f, 0x70, 0x73, 0x1a, 0x2f, 0x6d, 0x6d, 0x65, 0x73, 0x68, 0x2f, 0x70, 0x72, 0x6f, 0x74,
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x2f, 0x6d, 0x6d, 0x65, 0x73, 0x68, 0x2f, 0x70, 0x72, 0x6f,
	...
	0x74, 0x49, 0x44, 0x42, 0x27, 0x5a, 0x25, 0x6d, 0x6d, 0x65, 0x73, 0x68, 0x2e, 0x64, 0x65, 0x76,
	0x2f, 0x6d, 0x2d, 0x61, 0x70, 0x69, 0x2d, 0x67, 0x6f, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x2f, 0x72,
	0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2f, 0x6f, 0x70, 0x73, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_mmesh_protobuf_resources_v1_ops_project_proto_rawDescOnce sync.Once
	file_mmesh_protobuf_resources_v1_ops_project_proto_rawDescData = file_mmesh_protobuf_resources_v1_ops_project_proto_rawDesc
)

func file_mmesh_protobuf_resources_v1_ops_project_proto_rawDescGZIP() []byte {
	file_mmesh_protobuf_resources_v1_ops_project_proto_rawDescOnce.Do(func() {
		file_mmesh_protobuf_resources_v1_ops_project_proto_rawDescData = protoimpl.X.CompressGZIP(file_mmesh_protobuf_resources_v1_ops_project_proto_rawDescData)
	})
	return file_mmesh_protobuf_resources_v1_ops_project_proto_rawDescData
}

var file_mmesh_protobuf_resources_v1_ops_project_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_mmesh_protobuf_resources_v1_ops_project_proto_goTypes = []interface{}{
...
var file_mmesh_protobuf_resources_v1_ops_project_proto_depIdxs = []int32{
...
func init() { file_mmesh_protobuf_resources_v1_ops_project_proto_init() }
func file_mmesh_protobuf_resources_v1_ops_project_proto_init() {
	if File_mmesh_protobuf_resources_v1_ops_project_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_mmesh_protobuf_resources_v1_ops_project_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_mmesh_protobuf_resources_v1_ops_project_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_mmesh_protobuf_resources_v1_ops_project_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_mmesh_protobuf_resources_v1_ops_project_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_mmesh_protobuf_resources_v1_ops_project_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_mmesh_protobuf_resources_v1_ops_project_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_mmesh_protobuf_resources_v1_ops_project_proto_goTypes,
		DependencyIndexes: file_mmesh_protobuf_resources_v1_ops_project_proto_depIdxs,
		MessageInfos:      file_mmesh_protobuf_resources_v1_ops_project_proto_msgTypes,
	}.Build()
	File_mmesh_protobuf_resources_v1_ops_project_proto = out.File
	file_mmesh_protobuf_resources_v1_ops_project_proto_rawDesc = nil
	file_mmesh_protobuf_resources_v1_ops_project_proto_goTypes = nil
	file_mmesh_protobuf_resources_v1_ops_project_proto_depIdxs = nil
}
