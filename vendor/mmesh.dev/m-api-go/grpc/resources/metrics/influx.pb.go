...
const (
	Measurement_NODE Measurement = 0
)
...
type DataPoint struct {
	...
	// fields
	// NODE measurement
	// double netRxBps = 1101;
	// double netTxBps = 1102;
	NetRxBytes uint64 `protobuf:"varint,1103,opt,name=netRxBytes,proto3" json:"netRxBytes,omitempty"`
	NetTxBytes uint64 `protobuf:"varint,1104,opt,name=netTxBytes,proto3" json:"netTxBytes,omitempty"`
	// uint64 netRxPkts = 1105;
	// uint64 netTxPkts = 1106;
	NetDroppedPkts uint64 `protobuf:"varint,1107,opt,name=netDroppedPkts,proto3" json:"netDroppedPkts,omitempty"`
	// uint64 netRxErrs = 1108;
	// uint64 netTxErrs = 1109;
	// uint64 netRelayConns = 1121;
	// string netSrcDst = 1131;
	HostLoadAvg   float64 `protobuf:"fixed64,1201,opt,name=hostLoadAvg,proto3" json:"hostLoadAvg,omitempty"`
	HostCpuUsage  uint64  `protobuf:"varint,1211,opt,name=hostCpuUsage,proto3" json:"hostCpuUsage,omitempty"`   // uint64 -> double
	HostMemUsage  uint64  `protobuf:"varint,1221,opt,name=hostMemUsage,proto3" json:"hostMemUsage,omitempty"`   // uint64 -> double
	HostDiskUsage uint64  `protobuf:"varint,1231,opt,name=hostDiskUsage,proto3" json:"hostDiskUsage,omitempty"` // uint64 -> double
}
...
type DataPoints struct {
	...
	DataPoints []*DataPoint `protobuf:"bytes,101,rep,name=dataPoints,proto3" json:"dataPoints,omitempty"`
}
...
func (x *DataPoints) GetSubnetID() string {
	if x != nil {
		return x.SubnetID
	}
	return ""
...
type InfluxMetricRecord struct {
	...
	Value float64 `protobuf:"fixed64,122,opt,name=value,proto3" json:"value,omitempty"` // specific for metric-type measurements (NODE)
}
...
var file_mmesh_protobuf_resources_v1_metrics_influx_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x07, 0x6d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x22, 0xb2, 0x03, 0x0a, 0x09,
	...
	,
	...
	,
...
var file_mmesh_protobuf_resources_v1_metrics_influx_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_mmesh_protobuf_resources_v1_metrics_influx_proto_goTypes = []interface{}{
	...
	(*InfluxMetricRecord)(nil), // 3: metrics.InfluxMetricRecord
}
