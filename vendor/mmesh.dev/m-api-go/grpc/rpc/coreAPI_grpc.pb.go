...
func (c *coreAPIClient) SetUserCredentialsPassword(ctx context.Context, in *iam.SetUserCredentialsPasswordRequest, opts ...grpc.CallOption) (*status.StatusResponse, error) {
	out := new(status.StatusResponse)
...
func (UnimplementedCoreAPIServer) SetUserCredentialsPassword(context.Context, *iam.SetUserCredentialsPasswordRequest) (*status.StatusResponse, error) {
