...
// 	protoc        v4.25.1
// source: mmesh/protobuf/network/v1/nac/routing.proto
...
func (RoutingScope) Descriptor() protoreflect.EnumDescriptor {
	return file_mmesh_protobuf_network_v1_nac_routing_proto_enumTypes[0].Descriptor()
}

func (RoutingScope) Type() protoreflect.EnumType {
	return &file_mmesh_protobuf_network_v1_nac_routing_proto_enumTypes[0]
}
...
func (RoutingScope) EnumDescriptor() ([]byte, []int) {
	return file_mmesh_protobuf_network_v1_nac_routing_proto_rawDescGZIP(), []int{0}
}
...
func (x *RoutingDomain) Reset() {
	*x = RoutingDomain{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mmesh_protobuf_network_v1_nac_routing_proto_msgTypes[0]
...
var File_mmesh_protobuf_network_v1_nac_routing_proto protoreflect.FileDescriptor

var file_mmesh_protobuf_network_v1_nac_routing_proto_rawDesc = []byte{
	...
	0x52, 0x4b, 0x10, 0x01, 0x42, 0x25, 0x5a, 0x23, 0x6d, 0x6d, 0x65, 0x73, 0x68, 0x2e, 0x64, 0x65,
	0x76, 0x2f, 0x6d, 0x2d, 0x61, 0x70, 0x69, 0x2d, 0x67, 0x6f, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x2f,
	0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x2f, 0x6e, 0x61, 0x63, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}

var (
	file_mmesh_protobuf_network_v1_nac_routing_proto_rawDescOnce sync.Once
	file_mmesh_protobuf_network_v1_nac_routing_proto_rawDescData = file_mmesh_protobuf_network_v1_nac_routing_proto_rawDesc
)

func file_mmesh_protobuf_network_v1_nac_routing_proto_rawDescGZIP() []byte {
	file_mmesh_protobuf_network_v1_nac_routing_proto_rawDescOnce.Do(func() {
		file_mmesh_protobuf_network_v1_nac_routing_proto_rawDescData = protoimpl.X.CompressGZIP(file_mmesh_protobuf_network_v1_nac_routing_proto_rawDescData)
	})
	return file_mmesh_protobuf_network_v1_nac_routing_proto_rawDescData
}

var file_mmesh_protobuf_network_v1_nac_routing_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_mmesh_protobuf_network_v1_nac_routing_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_mmesh_protobuf_network_v1_nac_routing_proto_goTypes = []interface{}{
	(RoutingScope)(0),     // 0: nac.RoutingScope
	(*RoutingDomain)(nil), // 1: nac.RoutingDomain
}
var file_mmesh_protobuf_network_v1_nac_routing_proto_depIdxs = []int32{
...
func init() { file_mmesh_protobuf_network_v1_nac_routing_proto_init() }
func file_mmesh_protobuf_network_v1_nac_routing_proto_init() {
	if File_mmesh_protobuf_network_v1_nac_routing_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_mmesh_protobuf_network_v1_nac_routing_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_mmesh_protobuf_network_v1_nac_routing_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_mmesh_protobuf_network_v1_nac_routing_proto_goTypes,
		DependencyIndexes: file_mmesh_protobuf_network_v1_nac_routing_proto_depIdxs,
		EnumInfos:         file_mmesh_protobuf_network_v1_nac_routing_proto_enumTypes,
		MessageInfos:      file_mmesh_protobuf_network_v1_nac_routing_proto_msgTypes,
	}.Build()
	File_mmesh_protobuf_network_v1_nac_routing_proto = out.File
	file_mmesh_protobuf_network_v1_nac_routing_proto_rawDesc = nil
	file_mmesh_protobuf_network_v1_nac_routing_proto_goTypes = nil
	file_mmesh_protobuf_network_v1_nac_routing_proto_depIdxs = nil
}
