...
func (x *RIB) Reset() {
	*x = RIB{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mmesh_protobuf_network_v1_routing_rib_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RIB) Descriptor() ([]byte, []int) {
	return file_mmesh_protobuf_network_v1_routing_rib_proto_rawDescGZIP(), []int{4}
}
...
func (x *ProxyRIB) Reset() {
	*x = ProxyRIB{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mmesh_protobuf_network_v1_routing_rib_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ProxyRIB) Descriptor() ([]byte, []int) {
	return file_mmesh_protobuf_network_v1_routing_rib_proto_rawDescGZIP(), []int{5}
}
...
var file_mmesh_protobuf_network_v1_routing_rib_proto_rawDesc = []byte{
	...
	0x76, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x2b, 0x6d, 0x6d, 0x65, 0x73, 0x68, 0x2f,
...
var file_mmesh_protobuf_network_v1_routing_rib_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
...
func file_mmesh_protobuf_network_v1_routing_rib_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_mmesh_protobuf_network_v1_routing_rib_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RIB); i {
			case 0:
				return &v.state
			case 1:
		...
		file_mmesh_protobuf_network_v1_routing_rib_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
